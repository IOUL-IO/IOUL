...
<span class="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">1OUL ADD-OnS</span>
<span class="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">UT1L ADD-OnS</span>
<span class="custom-text" style="position:absolute; top:53vh; left:6.41vw;">cREATE ADD-On</span>
<span class="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">UPDATE ADD-On</span>
...
<!-- Column 1 (36 vw) -->
<span class="custom-text content-text" style="position:absolute; top:35.4vh; left:36vw;">LATEST:</span>
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:36vw;">LEAgUE:</span>
...
<!-- Column 5 (79 vw) -->
<span class="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">cATALOg:</span>
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">LOOK UP:</span>
<span class="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">AO:</span>
<span class="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">AO:</span>
<span class="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">AO:</span>
<span class="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">AO:</span>
