...
export default function Page() {
  useEffect(() => {
    ...
    document.addEventListener('click', ({clientX:x, clientY:y}) => {
      ...
      if (nearEdge && !document.fullscreenElement) document.documentElement.requestFullscreen();
    });
  }, []);
  ...
  return (
    <>
      ...
      <div className="content-line content-line-one" style={ position: 'absolute', top: '47.8vh', left: '36vw', width: '36vw', height: '1px', background: 'rgba(230,230,230,0.28)' }></div>
      <div className="content-line content-line-two" style={ position: 'absolute', top: '47.8vh', left: '79vw', width: '14.8vw', height: '1px', background: 'rgba(230,230,230,0.28)' }></div>
      </div>
    </>
  );
}
