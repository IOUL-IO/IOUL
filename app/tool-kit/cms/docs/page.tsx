  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">Lg: 0</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:10.71vw;">Pg: 0</span>

    <span className="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">DP: 0</span>
    <span className="custom-text" style="position:absolute; top:59.2vh; left:10.71vw;">DT: 0</span>
    ...
    <span className="custom-text right-flow icon-align" style="position:absolute; top: 53vh; left:28.41vw;"><svg width="0.5rem" height="0.5rem" viewBox="0 0 8 8" shape-rendering="crispEdges" style="display:block"><rect x="0" y="0" width="8" height="1" fill="#111" /><rect x="0" y="7" width="7" height="1" fill="#111" /></svg></span>
    <span className="custom-text right-flow icon-bullet" style="position:absolute; top:59.2vh; left:28.41vw;"><svg width="0.5rem" height="0.5rem" viewBox="0 0 8 8" shape-rendering="crispEdges" style="display:block"><rect x="0" y="0" width="2.5" height="1" fill="#111" /><rect x="4" y="0" width="4" height="1" fill="#111" /><rect x="0" y="6" width="2.5" height="1" fill="#111" /><rect x="4" y="6" width="4" height="1" fill="#111" /></svg></span>
