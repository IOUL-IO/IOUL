    ...
    export default function Page() {
      ...
      useEffect(() => {
        ...
        script.id = 'legacy-ioul-script';
        script.textContent = `const pageContent = document.querySelector('.page-content');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('resize', update);
        ...
        return () => document.getElementById('legacy-ioul-script')?.remove();
      }, []);
      return (
