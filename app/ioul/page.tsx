  ...
  <div class="page-content">
    ...
    <div class="line fifth"></div>
      <div class="line mail-line" style="position:absolute; top:47.8vh; left:36vw; width:57.8vw; height:1px; background-color:rgba(230,230,230,0.28); opacity:0; transition: opacity 0.3s ease; z-index:9999;"></div>
    <div class="line sixth"></div>


      <div class="slide-container">
        <span class="account-text" style="position:absolute; top:35.4vh; left:-24.00vw; z-index:9999;">AccOUnT&nbsp;nAME</span>
        <span class="account-text" style="position:absolute; top:35.4vh; left:26.00vw; z-index:9999;">L1nK&nbsp;UP</span>
        <span class="account-text right-flow" style="position:absolute; top:35.4vh; left:33.19vw; z-index:9999;">0</span>
        <span class="account-text" style="position:absolute; top:77vh; left:-24.00vw; color:#111111; z-index:9999;">. . .</span>
        <div class="line account-line" style="position:absolute; top:41.6vh; left:-24.00vw; width:57.8vw; height:1px; background-color: rgba(230, 230, 230, 0.28); z-index:9999;"></div>
      </div>
<!-- Item lines -->
<div class="item-line item-line-one" style="position:absolute; top:47.8vh; left:96vw; width:36vw; z-index:9999;"></div>
<div class="item-line item-line-two" style="position:absolute; top:47.8vh; left:139vw; width:14.8vw; z-index:9999;"></div>


    <!-- Center lines -->
    <div class="center-line center-line-one" style="position:absolute; top:47.8vh; left:106.0vw; width:36vw; z-index:9999;"></div>
    <div class="center-line center-line-two" style="position:absolute; top:47.8vh; left:149.0vw; width:14.8vw; z-index:9999;"></div>

    <!-- Center texts -->
    <span class="center-text" style="position:absolute; top:35.4vh; left:106.0vw; z-index:9999;">UPDATES</span>
    <span class="center-text" style="position:absolute; top:41.6vh; left:106.0vw; z-index:9999;">cATALOg</span>

    <span class="center-text right-flow" style="position:absolute; top:35.4vh; left:119.0vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:41.6vh; left:119.0vw; z-index:9999;">0</span>

    <span class="center-text" style="position:absolute; top:35.4vh; left:128.0vw; z-index:9999;">T1cKETS</span>
    <span class="center-text" style="position:absolute; top:41.6vh; left:128.0vw; z-index:9999;">cOnTAcT</span>

    <span class="center-text right-flow" style="position:absolute; top:35.4vh; left:141.0vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:41.6vh; left:141.0vw; z-index:9999;">0</span>

    <span class="center-text" style="position:absolute; top:35.4vh; left:149.0vw; z-index:9999;">gET APP</span>
    <span class="center-text" style="position:absolute; top:41.6vh; left:149.0vw; z-index:9999;">AP1-LOg</span>

    <span class="center-text right-flow" style="position:absolute; top:35.4vh; left:163.4vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:41.6vh; left:163.4vw; z-index:9999;">0</span>

    <span class="center-text" style="position:absolute; top:53vh; left:149.0vw; z-index:9999;">LOg 0.01</span>
    <span class="center-text" style="position:absolute; top:59.2vh; left:149.0vw; z-index:9999;">LOg 0.02</span>
    <span class="center-text" style="position:absolute; top:65.4vh; left:149.0vw; z-index:9999;">LOg 0.03</span>
    <span class="center-text" style="position:absolute; top:71.6vh; left:149.0vw; z-index:9999;">LOg 0.04</span>

    <span class="center-text right-flow" style="position:absolute; top:53vh; left:163.4vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:59.2vh; left:163.4vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:65.4vh; left:163.4vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:71.6vh; left:163.4vw; z-index:9999;">0</span>

    <span class="center-text" style="position:absolute; top:53vh; left:106.0vw; z-index:9999;">LATEST</span>
    <span class="center-text" style="position:absolute; top:59.2vh; left:106.0vw; z-index:9999;">V1RALS</span>

    <span class="center-text right-flow" style="position:absolute; top:53vh; left:119.0vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:59.2vh; left:119.0vw; z-index:9999;">0</span>

    <span class="center-text" style="position:absolute; top:53vh; left:128.0vw; z-index:9999;">cAREERS</span>
    <span class="center-text" style="position:absolute; top:59.2vh; left:128.0vw; z-index:9999;">ARcH1VE</span>

    <span class="center-text right-flow" style="position:absolute; top:53vh; left:141.0vw; z-index:9999;">0</span>
    <span class="center-text right-flow" style="position:absolute; top:59.2vh; left:141.0vw; z-index:9999;">0</span>


<!-- Item texts -->
<span class="item-text" style="position:absolute; top:35.4vh; left:96vw; z-index:9999;">1ncOME</span>
<span class="item-text" style="position:absolute; top:41.6vh; left:96vw; z-index:9999;">cL1EnT</span>

<span class="item-text right-flow" style="position:absolute; top:35.4vh; left:109vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:41.6vh; left:109vw; z-index:9999;">0</span>

<span class="item-text" style="position:absolute; top:35.4vh; left:118vw; z-index:9999;">T1cKETS</span>
<span class="item-text" style="position:absolute; top:41.6vh; left:118vw; z-index:9999;">1nQU1RY</span>

<span class="item-text right-flow" style="position:absolute; top:35.4vh; left:131vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:41.6vh; left:131vw; z-index:9999;">0</span>

<span class="item-text" style="position:absolute; top:35.4vh; left:139vw; z-index:9999;">OnL1nE</span>
<span class="item-text" style="position:absolute; top:41.6vh; left:139vw; z-index:9999;">JO1nED</span>

<span class="item-text right-flow" style="position:absolute; top:35.4vh; left:153.4vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:41.6vh; left:153.4vw; z-index:9999;">0</span>

<span class="item-text" style="position:absolute; top:53vh; left:139vw; z-index:9999;">JOBLOg</span>
<span class="item-text" style="position:absolute; top:59.2vh; left:139vw; z-index:9999;">H1R1ngS</span>
<span class="item-text" style="position:absolute; top:65.4vh; left:139vw; z-index:9999;">ORDERS</span>
<span class="item-text" style="position:absolute; top:71.6vh; left:139vw; z-index:9999;">1nV1TES</span>

<span class="item-text right-flow" style="position:absolute; top:53vh; left:153.4vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:59.2vh; left:153.4vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:65.4vh; left:153.4vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:71.6vh; left:153.4vw; z-index:9999;">0</span>

<span class="item-text" style="position:absolute; top:53vh; left:96vw; z-index:9999;">cL1cKS</span>
<span class="item-text" style="position:absolute; top:59.2vh; left:96vw; z-index:9999;">LEADS</span>

<span class="item-text right-flow" style="position:absolute; top:53vh; left:109vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:59.2vh; left:109vw; z-index:9999;">0</span>

<span class="item-text" style="position:absolute; top:53vh; left:118vw; z-index:9999;">AD cTR</span>
<span class="item-text" style="position:absolute; top:59.2vh; left:118vw; z-index:9999;">AD cPc</span>

<span class="item-text right-flow" style="position:absolute; top:53vh; left:131vw; z-index:9999;">0</span>
<span class="item-text right-flow" style="position:absolute; top:59.2vh; left:131vw; z-index:9999;">0</span>


      <div class="hover-area"></div>
      <span class="chat-text" id="chatText">cHAT . . .</span>
      <span class="mail-text" style="position:absolute; top:35.4vh; left:36vw; z-index:9999; font-family:'Distill Expanded',sans-serif; color:#111111; letter-spacing:0.28vw; font-size:0.47rem; text-shadow:0.001rem 0.001rem 0 #717171, -0.001rem -0.001rem 0 #717171; opacity:0; transition: opacity 0.3s ease;">TO:</span>
      <span class="mail-text" style="position:absolute; top:41.6vh; left:36vw; z-index:9999; font-family:'Distill Expanded',sans-serif; color:#111111; letter-spacing:0.28vw; font-size:0.47rem; text-shadow:0.001rem 0.001rem 0 #717171, -0.001rem -0.001rem 0 #717171; opacity:0; transition: opacity 0.3s ease;">SUBJEcT:</span>
      <span class="mail-text" style="position:absolute; top:35.4vh; left:89vw; z-index:9999; font-family:'Distill Expanded',sans-serif; color:#111111; letter-spacing:0.28vw; font-size:0.47rem; text-shadow:0.001rem 0.001rem 0 #717171, -0.001rem -0.001rem 0 #717171; opacity:0; transition: opacity 0.3s ease;">cc</span>
      <span class="mail-text" style="position:absolute; top:35.4vh; left:91.9vw; z-index:9999; font-family:'Distill Expanded',sans-serif; color:#111111; letter-spacing:0.28vw; font-size:0.47rem; text-shadow:0.001rem 0.001rem 0 #717171, -0.001rem -0.001rem 0 #717171; opacity:0; transition: opacity 0.3s ease;">Bcc</span>
      <span class="mail-text" style="position:absolute; top:41.6vh; left:91.1vw; z-index:9999; font-family:'Distill Expanded',sans-serif; color:#111111; letter-spacing:0.28vw; font-size:0.47rem; text-shadow:0.001rem 0.001rem 0 #717171, -0.001rem -0.001rem 0 #717171; opacity:0; transition: opacity 0.3s ease;">SEnD</span>
      ...
      <div class="account-container" style="top:35.4vh; left:29.11vw; transform:translateX(-49vw);" data-offset="-49" data-slide-group="account">
        <span class="custom-text right-flow" style="position:absolute; right:0; z-index:9999;">0</span>
      </div>
