    ...
    export default function Page() {
      return (
        <>
          <Head>
            <title>IOUL</title>
            <meta charset="utf-8"/><meta content="width=device-width, initial-scale=1.0" name="viewport"/><link href="/center/library/favicon.png" rel="icon" type="image/png"/><link href="/center/library/styles.css" rel="stylesheet"/>
          </Head>
