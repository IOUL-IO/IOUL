...
export default function Page() {
  ...
  return (
    <div>
      ...
      <span className="custom-text" style={{position:'absolute',top:'41.6vh',left:'91.04vw',zIndex:4,fontFamily:"'Distill Expanded',sans-serif",color:'#111',letterSpacing:'0.28vw',fontSize:'0.47rem',textShadow:'0.001rem 0.001rem #717171,-0.001rem -0.001rem 0 #717171'}}>SEnD</span>
