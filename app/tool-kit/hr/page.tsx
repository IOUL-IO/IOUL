...
<span class="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">LABOR LOg</span>
<span class="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">LEgAL LOg</span>
<span class="custom-text" style="position:absolute; top:53vh; left:6.41vw;">LEDgER</span>
<span class="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">LADDER</span>
...
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:36vw;">On DUTY:</span>
...
<!-- Column 5 (79 vw) -->
<span class="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">JO1n LOg</span>
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">L1FT LOg</span>
<span class="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">OAR:</span>
<span class="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">QcO:</span>
<span class="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">cPH:</span>
<span class="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">1PR:</span>
