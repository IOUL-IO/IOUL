  ...
  <div className="page-content">
    ...
    <div className="custom-line job-item"></div>


<!-- Item lines -->
<div className="job-line job-line-one" style="position:absolute; top:47.8vh; left:36vw; width:36vw;"></div>
<div className="job-line job-line-two" style="position:absolute; top:47.8vh; left:79vw; width:14.8vw;"></div>


    <!-- Center lines -->
    <div className="freelance-line freelance-line-one" style="position:absolute; top:47.8vh; left:106.0vw; width:36vw;"></div>
    <div className="freelance-line freelance-line-two" style="position:absolute; top:47.8vh; left:149.0vw; width:14.8vw;"></div>
...
<div className="freelance-items-container" style="position:absolute; z-index:1;">
  <!-- labels -->
