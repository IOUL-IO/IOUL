    ...
    export default function Page() {
      return (
        <>
          <Head>
            <title>IOUL</title>
            <meta content="notranslate" name="google"/><meta content="en" http-equiv="Content-Language"/><meta charset="utf-8"/><meta content="width=device-width, initial-scale=1.0" name="viewport"/><link href="/ioul/favicon.png" rel="icon" type="image/png"/><link href="/ioul/styles.css" rel="stylesheet"/><style>
.hidden { display:none !important; }
</style>
          </Head>
          <div dangerouslySetInnerHTML={ { __html: `<p lang="en" style="display:none">This page is already in English. No translation is needed.</p>
...
`}</Script>
      <Script id="inline-script-1" strategy="afterInteractive">{`
...
`}</Script>
      <Script id="inline-script-2" strategy="afterInteractive">{`
...
`}</Script>
      <Script id="inline-script-3" strategy="afterInteractive">{`
...
`}</Script>
      <Script id="inline-script-4" strategy="afterInteractive">{`
