...
`;
  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">UPLOAD LOg</span>
    <span className="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">LAYOUT LOg</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">TOOL LOg</span>
...
<!-- Column 5 (79 vw) -->
<span className="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">HE1gHT:</span>
<span className="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">LEngTH:</span>

<span className="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">1-DOc</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">cELL</span>
<span className="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">FORM</span>
<span className="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">WALL</span>
