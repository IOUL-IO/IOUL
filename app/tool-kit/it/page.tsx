...
<span class="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">1DEnT1TY LOg</span>
<span class="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">COnTROL PAD</span>
<span class="custom-text" style="position:absolute; top:53vh; left:6.41vw;">DATA DEPOT</span>
<span class="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">DEV1cE LOg</span>
...
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:36vw;">AcT1VE:</span>
...
<!-- Column 5 (79 vw) -->
<span class="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">ALERTS</span>
<span class="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">REPORT</span>
<span class="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">HD:</span>
<span class="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">HD:</span>
<span class="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">HD:</span>
<span class="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">HD:</span>
