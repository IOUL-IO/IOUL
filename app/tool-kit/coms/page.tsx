  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">AD OFF1cE</span>
    <span className="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">AFF1L1ATE</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">LAUncH nOTE</span>
    <span className="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">LAUncH cHAT</span>
...
<span className="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">cPc</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">cPA</span>
<span className="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">cPL</span>
