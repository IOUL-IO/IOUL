    ...
    export default function Page() {
      return (
        <>
          <Head>
            <title>IOUL</title>
            <meta charset="utf-8"/><meta content="width=device-width, initial-scale=1.0" name="viewport"/><link href="/tool-kit/it/favicon.png" rel="icon" type="image/png"/><link href="/tool-kit/it/styles.css" rel="stylesheet"/>
          </Head>
