...
const IOULPage: React.FC = () => {
  ...
  // Global click handler for edge interactions
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener('click', handleEdgeClick);
    };
  }, []);
      ...
      <div className="non-fullscreen" translate="no">
        ...
        <div className="page-content">
          ...
          <div
            ...
            onMouseEnter={() => { if (chatTextRef.current) chatTextRef.current.style.opacity = '1'; }}
            onMouseLeave={() => { if (chatTextRef.current) chatTextRef.current.style.opacity = '0'; }}
          />
          <span
            className="chat-text"
            ref={chatTextRef}
