    ...
    <div className="non-fullscreen" translate="no">
      ...
      <div className="page-content">
        ...
        <div className="other-content">
          ...
          <div className="line fourth" />          <div className="line mail-line" style={{ position: 'absolute', top: '47.8vh', left: '36vw', width: '57.8vw', height: '1px', backgroundColor: 'rgba(230,230,230,0.28)', zIndex: 1 }} />        </div>
