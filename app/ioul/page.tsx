  ...
  return (
    <div className="non-fullscreen" translate="no">
      ...
      <div className="page-content">
        ...
        <span className="mail-text" style={{position:'absolute',top:'35.4vh',left:'36vw',backgroundColor:'#717171',opacity: state === 1 ? 1 : 0,pointerEvents: state === 1 ? 'auto' : 'none',transition:'opacity 0.3s ease'}}>TO:</span>
        <span className="mail-text" style={{position:'absolute',top:'41.6vh',left:'36vw',backgroundColor:'#717171',opacity: state === 1 ? 1 : 0,pointerEvents: state === 1 ? 'auto' : 'none',transition:'opacity 0.3s ease'}}>SUBJEcT:</span>
        <span className="mail-text" style={{position:'absolute',top:'35.4vh',left:'89vw',backgroundColor:'#717171',opacity: state === 1 ? 1 : 0,pointerEvents: state === 1 ? 'auto' : 'none',transition:'opacity 0.3s ease'}}>cc</span>
        <span className="mail-text" style={{position:'absolute',top:'35.4vh',left:'91.9vw',backgroundColor:'#717171',opacity: state === 1 ? 1 : 0,pointerEvents: state === 1 ? 'auto' : 'none',transition:'opacity 0.3s ease'}}>Bcc</span>
        <span className="mail-text" style={{position:'absolute',top:'41.6vh',left:'91.1vw',backgroundColor:'#717171',opacity: state === 1 ? 1 : 0,pointerEvents: state === 1 ? 'auto' : 'none',transition:'opacity 0.3s ease'}}>SEnD</span>
