  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">LABOR LOg</span>
    <span className="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">LEgAL LOg</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">LEDgER</span>
    <span className="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">LADDER</span>
...
<span className="custom-text content-text" style="position:absolute; top:41.6vh; left:36vw;">On DUTY:</span>
...
<!-- Column 5 (79 vw) -->
<span className="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">JO1n LOg</span>
<span className="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">L1FT LOg</span>

<span className="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">OAR:</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">QcO:</span>
<span className="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">cPH:</span>
