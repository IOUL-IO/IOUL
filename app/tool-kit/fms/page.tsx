...
`;
  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">VEnTURE</span>
    <span className="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">AccOUnT</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">cHARgE</span>
    <span className="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">LEDgER</span>
...
<!-- Column 1 (36 vw) -->
<span className="custom-text content-text" style="position:absolute; top:35.4vh; left:36vw;">1ncOME:</span>
<span className="custom-text content-text" style="position:absolute; top:41.6vh; left:36vw;">cL1EnT:</span>
...
<!-- Column 5 (79 vw) -->
<span className="custom-text content-text" style="position:absolute; top:35.4vh; left:79vw;">D1SPUTE:</span>
<span className="custom-text content-text" style="position:absolute; top:41.6vh; left:79vw;">OngO1ng:</span>

<span className="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">ARR</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">cLV</span>
<span className="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">ARU</span>
<span className="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">cP1</span>
