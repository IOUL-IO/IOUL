    ...
    export default function Page() {
      ...
      let stage = 0;
      const grp1 = Array.from(document.querySelectorAll('.freelance_text, .freelance-text, .freelance-line'));
      const grp2 = Array.from(document.querySelectorAll('.job_text, .job-text, .job-line'));
