...
<script>
/* --- Updated staggered gap logic to support 1→2→1→0 loop on forward trigger --- */
document.addEventListener('DOMContentLoaded', () => {
  ...
  function toStage2() { animating = true; move(itemEls, -2 * DIST - GAP); move(centerEls, -DIST - GAP); setTimeout(() => { animating = false; itemStage = 2; centerStage = 1; }, DUR + STAGGER); }
  function backToStage1() { animating = true; move(centerEls, 0); move(itemEls, -DIST); setTimeout(() => { animating = false; itemStage = 1; centerStage = 0; }, DUR + STAGGER); }
