...
export default function Page() {
  useEffect(() => {
    ...
    utilLine?.addEventListener('click', () => {
      if (step !== 0) return;
      // slide-out login elements
      fadeOutEls(loginEls).then(() => {
        // then slide-in OPEN & HELP texts
        fadeInEls([openText!, helpText!] as unknown as NodeListOf<Element>);
        // switch stage to trigger CSS transforms
