...
export default function Page() {
  return (
    <>
      <Head>
        <link rel="stylesheet" href="/tool-kit/jobs/styles.css" />
        <title>IOUL</title>
      </Head>
...
<div id="ledger-reset-area" style="position:fixed; left:0; top:28.5vh; width:6.37vw; height:55.5vh; z-index:200; background:rgba(0,0,0,0);"></div>` } />
      <Script id="script-index" strategy="afterInteractive">{`/* --- Updated staggered gap logic injected by ChatGPT on 2025‑06‑02 --- */
...
(function(){
  ...
  /* --- JobShift patch 2025-06-11 --- */`}</Script>
    </>
  );
}
