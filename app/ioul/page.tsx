...
const rawHtml = `<p style="display:none" lang="en">This page is already in English. No translation is needed.</p>
...
const IoulPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="page-content" dangerouslySetInnerHTML={ { __html: rawHtml } } />
