  ...
  return (
    <div className="non-fullscreen" translate="no">
      ...
      <div className="page-content">
        ...
        <span className="mail-text to" style={{
          position: 'absolute',
          top: '35.4vh',
          left: '36vw',
          zIndex: 1,
          ...
          opacity: state === 1 ? 1 : 0,
          display: state === 1 ? 'inline-block' : 'none',
          pointerEvents: state === 1 ? 'auto' : 'none',
          transition: 'opacity 0.3s ease',
        }}>TO:</span>
        <span className="mail-text subject" style={{
          position: 'absolute',
          top: '41.6vh',
          left: '36vw',
          zIndex: 1,
        ...
        <span className="mail-text cc" style={{
          position: 'absolute',
          top: '35.4vh',
          left: '89vw',
          zIndex: 1,
        ...
        <span className="mail-text bcc" style={{
          position: 'absolute',
          top: '35.4vh',
          left: '91.9vw',
          zIndex: 1,
        ...
        <span className="mail-text send" style={{
          position: 'absolute',
          top: '41.6vh',
          left: '91.1vw',
          zIndex: 1,
