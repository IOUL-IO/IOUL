...
`;
  ...
  <div className="page-content">
    ...
    <span className="custom-text" style="position:absolute; top:35.4vh; left:6.41vw;">1nVEnTORY</span>
    <span className="custom-text" style="position:absolute; top:41.6vh; left:6.41vw;">ORDER LOg</span>
    <span className="custom-text" style="position:absolute; top:53vh; left:6.41vw;">VEnDOR DATA</span>
    <span className="custom-text" style="position:absolute; top:59.2vh; left:6.41vw;">cHAnnEL LOg</span>
...
<span className="custom-text content-text" style="position:absolute; top:53vh;   left:79vw;">O-LOg</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:79vw;">O-LOg</span>
<span className="custom-text content-text" style="position:absolute; top:65.4vh; left:79vw;">O-LOg</span>
<span className="custom-text content-text" style="position:absolute; top:71.6vh; left:79vw;">O-LOg</span>
...
<span className="custom-text content-text" style="position:absolute; top:53vh; left:36vw;">OOS</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:36vw;">LSU</span>

<span className="custom-text content-text right-flow" style="position:absolute; top:53vh; left:49.7vw;">0</span>
<span className="custom-text content-text right-flow" style="position:absolute; top:59.2vh; left:49.7vw;">0</span>

<span className="custom-text content-text" style="position:absolute; top:53vh; left:58.7vw;">OSU</span>
<span className="custom-text content-text" style="position:absolute; top:59.2vh; left:58.7vw;">OPO</span>

<span className="custom-text content-text right-flow" style="position:absolute; top:53vh; left:71vw;">0</span>
<span className="custom-text content-text right-flow" style="position:absolute; top:59.2vh; left:71vw;">0</span>    
